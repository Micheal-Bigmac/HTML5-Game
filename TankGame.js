...
function enemyTank(x, y, direct, color) {
    ...
    this.run = function () {
        ...
        this.step++;
        if (this.missilelive == false && this.live) {
            switch (this.direct) {
                case 0:
            ...
            var EnemyTimer;
            EnemyTimer = window.setInterval("enemyMissiles[" + (enemyMissiles.length - 1) + "].run()", 50);
                    ...
                    switch (enemyTank.direct) {
                        ...
                        case 2:
                            if (HeroMissile.x > enemyTank.x && HeroMissile.x < enemyTank.x + 20
                                ...
                                var bmb = new bomb(enemyTank.x, enemyTank.y);
                                Bombs.push(bmb);
                            }
                            break;
                        case 1:
    ...
    for (var i = 0; i < Bombs.length; i++) {
        ...
        if(bomb.live){
            if ( bomb.blood > 6) {
                ...
                image1.src = "bomb_1.gif";
                var x = bomb.x;
                var y = bomb.y;
                image1.onload();
                {
                    cxt.drawImage(image1, x, y, 30, 30);
                }
            }
        }
    }
